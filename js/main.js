...
$(document).ready(function($){
	...
	var libData = libSlider.data('owlCarousel');
	...
	var libTgt = $('.lib-ctrl').find('.go');
	libTgt.on('click', function(e){
		e.preventDefault();
		if( $(this).hasClass('go-left') ) {
			libData.prev();
		} else {
	...
	if ( $mapWrapper.length > 0 ) {
        ...
        map.addMarker({
            ...
            infoWindow: {
                content: '<p>Quantum Mobile - al. Hallera 190/31, 53-203 Wrocław</p>'
            }
        });
	}
